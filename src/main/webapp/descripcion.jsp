...
<%@ page import="com.proyecto.moviesplay.ABB" %>
<%@ page import="static com.proyecto.moviesplay.ABB.actores" %>
<%@ page import="com.proyecto.moviesplay.Actores" %>
<%@ page import="static com.proyecto.moviesplay.ABB.actores2" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="java.util.Stack" %>
<%@ page import="com.proyecto.moviesplay.ABBServlet" %>
<%@ page import="static com.proyecto.moviesplay.ABBServlet.root" %>
            ...
            %>
                            ...
                            <div id="eliminarActor<%= root.getNombreActor() %>" class="modal modal-fixed-footer" style="background: #131313; height: 18rem; overflow: auto; border-radius: 0.5rem">
                                ...
                                <div class="modal-footer" style="background: #131313">
                                    ...
                                    %>
                                    <a href="#!" onclick="eliminarActor('<%= root.getNombreActor() %>','<%= lde.getActual().getId() %>')" class="waves-effect waves-green btn-flat" style="background-color: red; color: #ffffff; border-radius: .5rem;">Aceptar</a>
                                </div>
                            </div>
            <%
