...
<%@ page import="com.proyecto.moviesplay.CircularServlet" %>
<%@ page import="com.proyecto.moviesplay.DoblementeEnlazadaServlet" %>
...
<%@ page import="static com.proyecto.moviesplay.ABBServlet.*" %>
<%@ page import="static com.proyecto.moviesplay.ABBServlet.flagAgregadoA" %>
<%@ page import="com.proyecto.moviesplay.ABBServlet" %>
...
<main>
    ...
    <section class="cartelera">
        ...
        %>
        <!-- Modal Trigger -->
        <a class="waves-effect waves-light btn modal-trigger right" href="#modal1" style="margin-top: -20px; background: #E50914"><i class="bi bi-plus-circle" style="vertical-align:middle"></i> Agregar Peliculas </a>

        <!-- Modal Structure -->
        <div id="modal1" class="modal" style="background: #131313">
            <div class="modal-content">
                <h4 class="titulo-form" style="background: linear-gradient(90deg, #d53369 0%, #daae51 100%); padding: 15px; border-radius: 1rem; text-align: center">
